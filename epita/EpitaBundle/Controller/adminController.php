...
use Epita\EpitaBundle\Entity\admin;
use Epita\EpitaBundle\Form\adminType;
...
class adminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EpitaEpitaBundle:admin')->findAll();
     ...
     * @Method("POST")
     * @Template("EpitaEpitaBundle:admin:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EpitaEpitaBundle:admin')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EpitaEpitaBundle:admin:edit.html.twig")
     */
